    ...
    def build(self, build_information):
        ...
        if self.player_inventory(build_information.get_build_type()):
            ...
            if build_information.get_build_type() == "Road":
                location_to_build = self.game_state.get_board().get_tile_array()[build_information.get_row()]\
                    [build_information.get_column()].get_edge(build_information.get_edge())
                ...
                location_to_build = self.game_state.get_board().get_tile_array()[build_information.get_row()]\
                    [build_information.get_column()].get_vertex(build_information.get_vertex())
                if self.check_location(location_to_build):
                    self.build_item(location_to_build)
